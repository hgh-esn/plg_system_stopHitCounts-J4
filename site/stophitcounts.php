...
class plgSystemstopHitCounts extends JPlugin
{
 ...
 //		echo '<br >' .'1-context=' .$context;
 //		echo '<br >' .'2a-usergp0='  .$user->groups[0];
 //		echo '<br >' .'2b-usergp2='  .$user->groups[2];
 //		echo '<br >' .'3-userid='  .$user->id;
...
//		if ($ret !== false)   // could reset hitcounts
		...
		$bots1 = array(
      'ABACHOBot','Accoona-AI-Agent','AddSugarSpiderBot','AnyApexBot','Arachmo','B-l-i-t-z-B-O-T',
